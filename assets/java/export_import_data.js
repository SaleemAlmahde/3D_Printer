...
function exportAdminData() {
  ...
  showToast("✅ تم حفظ نسخة احتياطية من بيانات المدير بنجاح!", 3000, "green");
}
    ...
    reader.onload = function (e) {
      try {
        ...
        if (importedData.stores && Array.isArray(importedData.stores)) {
          localStorage.setItem(
            "pointsOfSale",
            JSON.stringify(importedData.stores),
          );
        }
        // ... تحديث باقي المفاتيح ...

        showToast(
          "✅ تم استعادة البيانات بنجاح! سيتم إعادة تحميل الصفحة.",
          3000,
          "green",
        );
        ...
        showToast(
          "❌ خطأ: فشل قراءة أو تحليل ملف JSON. تأكد أنه ملف صحيح.",
          4000,
          "red",
        );
